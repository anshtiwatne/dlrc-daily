			...
			<NavbarContent justify="start">
				<NavbarBrand>
					...
					>
						...
						/>
						<p
							className={`${"font-black text-opacity-75"} ${navTransparency && !isMenuOpen ? "text-animate-disappear text-neutral-200" : "text-black text-opacity-100 dark:text-neutral-300"} ${robotoSlab.className}`}
							style={{
								textShadow:
